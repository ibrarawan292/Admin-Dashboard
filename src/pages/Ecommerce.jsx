  ...
  return (
    <div className='mt-12'>
      <div className='flex flex-wrap lg:flex-nowrap justify-center'>
        ...
        h-44 rounded-xl w-full lg:w-80 p-8 pt-8 m-3 bg-hero-pattern
        bg-no-repeat bg-cover bg-center'>
          <div className='flex justify-between items-center'>
            <div>
              <p className='font-bold text-gray-400'>Earnings</p>
              <p className='text-2xl'>$43,334.34</p>
            </div>
          </div>
          <div className='mt-6'>
            <Button 
      ...
      <div className='flex gap-10 flex-wrap justify-center'>
        <div className='bg-white dark:text-gray-200 dark"bg-secondary-bg m-3
            ...
            <div className='border-r-1 border-color m-4 pr-10'>
             <div>
              <p>
                ...
                rounded-full text-white bg-green-400 ml-3 text-xs'>23%
                </span>
              </p>
             ...
             <div className='mt-8'>
              <p>
                <span className='text-3xl font-semibold'>$48,857</span>
              </p>
